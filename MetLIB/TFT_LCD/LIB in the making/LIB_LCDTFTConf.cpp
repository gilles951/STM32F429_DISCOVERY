...
void LCDTFTConf::LCD_AF_GPIOConfig(void)
{
...
void LCDTFTConf::LCD_CtrlLinesWrite(GPIO_TypeDef* GPIOx, uint16_t CtrlPins, BitAction BitVal)
{
  /* Set or Reset the control line */
  GPIO_WriteBit(GPIOx, (uint16_t)CtrlPins, (BitAction)BitVal);
}

void LCDTFTConf::LCD_ChipSelect(FunctionalState NewState)
{
  if (NewState == DISABLE)
  {
...
void LCDTFTConf::LCD_SPIConfig(void)
{
...
void LCDTFTConf::LCD_PowerOn(void)
{
...
void LCDTFTConf::LCD_WriteCommand(uint8_t LCD_Reg)
{
...
void LCDTFTConf::LCD_LayerInit(void)
{
...
void LCDTFTConf::LCD_SetLayer(uint32_t Layerx)
{
...
void LCDTFTConf::delay(__IO uint32_t nCount)
{
